            ...
            <nav class="flex mb-4 sm:mb-8 overflow-x-auto" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3 whitespace-nowrap">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-emerald-300 mr-2"></i>
                            <span class="text-emerald-800 font-medium">Edit</span>
                        </div>
                    </li>
                </ol>
            </nav>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="time" name="open_at" id="open_at"
                                    value="{{ old('open_at', \Carbon\Carbon::parse($destination->open_at)->format('H:i')) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 transition duration-150 ease-in-out">
                                @error('open_at')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="time" name="close_at" id="close_at"
                                    value="{{ old('close_at', \Carbon\Carbon::parse($destination->close_at)->format('H:i')) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 transition duration-150 ease-in-out">
                                @error('close_at')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <div id="dropZone"
                                    ...
                                    <!-- Upload content -->
                                    <div id="dropZoneContent" class="{{ $destination->thumbnail ? 'hidden' : '' }}">
                                    ...
                                    <!-- Image preview -->
                                    <div id="imagePreview" class="{{ $destination->thumbnail ? '' : 'hidden' }} mt-4">
                                        <div class="relative max-w-sm mx-auto">
                                            <img src="{{ $destination->thumbnail ? asset('storage/images/destinations/' . $destination->thumbnail) : '#' }}"
