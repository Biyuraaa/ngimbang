            ...
            <div class="bg-white rounded-2xl shadow-sm border border-emerald-100 p-4 sm:p-6 mb-4 sm:mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Tambah Wahana Baru</h2>
                            <p class="text-sm text-emerald-600">Tambahkan wahana baru untuk </p>
                        </div>
                    </div>
                ...
                <form action="{{ route('destinations.attractions.store', $destination) }}" method="POST"
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                            ...
                            value="{{ old('name') }}" placeholder="Masukkan nama wahana">
                        @error('name')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <!-- Hidden file input -->
                            <input type="file" name="thumbnail" id="thumbnail" accept="image/*" class="hidden" required>
