        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-emerald-100 p-4 sm:p-6 mb-4 sm:mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Daftar Event</h2>
                            <p class="text-sm text-emerald-600">Kelola Event di Desa Gunung Sari</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border-0 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-4">
                    <h2 class="text-white font-semibold text-xl">Daftar Event</h2>
                </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-emerald-50">
                                <th class="px-6 py-4 text-left text-sm font-semibold text-emerald-700">Judul Event</th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-emerald-700">Tanggal Mulai</th>
                                ...
                                <tr class="hover:bg-emerald-50/60 transition-all duration-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-600">
                                            {{ $event->start_at ? \Carbon\Carbon::parse($event->start_at)->format('d M Y H:i') : '-' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr>
                                    <td colspan="{{ Auth::user()->hasRole('admin') ? '6' : '5' }}" class="px-6 py-8">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-emerald-800 font-medium mb-1">Belum ada data event</h3>
                                            <p class="text-emerald-600 text-sm">Silakan tambahkan event baru</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
