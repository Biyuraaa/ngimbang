                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-emerald-600">Tambahkan Event baru di Desa Ngimbang</p>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="title" id="title" required
                                    ...
                                    value="{{ old('title') }}" placeholder="Contoh: Festival Budaya Desa Ngimbang">
                                @error('title')
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="location" id="location" required
                                    class="block w-full rounded-xl border-emerald-200 shadow-sm focus:border-emerald-500 
                                           focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition-shadow duration-300"
                                    value="{{ old('location') }}" placeholder="Contoh: Balai Desa Ngimbang">
                                @error('location')
                                    <p class="text-sm text-red-600"><i
                                            class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                @enderror
