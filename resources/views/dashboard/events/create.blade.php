            ...
            <nav class="flex mb-4 sm:mb-8 overflow-x-auto" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3 whitespace-nowrap">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-emerald-300 mx-2"></i>
                            <span class="text-emerald-800 font-medium">Tambah Event</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-emerald-100 p-4 sm:p-6 mb-4 sm:mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Tambah Event Baru</h2>
                            <p class="text-sm text-emerald-600">Tambahkan Event baru di Desa Gunung Sari</p>
                        </div>
                    </div>
                        ...
                        <div class="relative">
                            <div
                                ...
                                <img id="image-preview" src="#" alt="Preview"
                                    class="hidden w-full h-full rounded-2xl object-cover">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="title" id="title" required
                                    ...
                                    value="{{ old('title') }}" placeholder="Contoh: Festival Budaya Desa Gunung Sari">
                                @error('title')
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="location" id="location" required
                                    class="block w-full rounded-xl border-emerald-200 shadow-sm focus:border-emerald-500 
                                           focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition-shadow duration-300"
                                    value="{{ old('location') }}" placeholder="Contoh: Balai Desa Gunung Sari">
                                @error('location')
                                    <p class="text-sm text-red-600"><i
                                            class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                @enderror
                                ...
                                <div class="relative">
                                    ...
                                    <input type="url" name="registration_url" id="registration_url"
                                        class="block w-full pl-10 rounded-xl border-emerald-200 shadow-sm focus:border-emerald-500 
                                               focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition-shadow duration-300"
                                        value="{{ old('registration_url') }}" placeholder="https://example.com/register">
                                </div>
                    ...
                    <div class="border-t border-emerald-100 pt-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" id="description" rows="6" required
                                class="block w-full rounded-xl border-emerald-200 shadow-sm focus:border-emerald-500 
                                       focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition-shadow duration-300"
                                placeholder="Jelaskan detail acara, termasuk rundown dan informasi penting lainnya">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-sm text-red-600"><i
                                        class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                            @enderror
