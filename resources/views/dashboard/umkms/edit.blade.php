                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-emerald-600">Perbarui informasi UMKM yang ada</p>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                    ...
                                    value="{{ old('name', $umkm->name) }}" placeholder="Masukkan nama UMKM">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="owner" id="owner" required
                                    class="mt-1 block w-full rounded-lg border-emerald-200 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                                    value="{{ old('owner', $umkm->owner) }}" placeholder="Masukkan nama pemilik">
                                @error('owner')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" required
                                    class="mt-1 block w-full rounded-lg border-emerald-200 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                                    value="{{ old('email', $umkm->email) }}" placeholder="Masukkan email">
                                @error('email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone"
                                    class="mt-1 block w-full rounded-lg border-emerald-200 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                                    value="{{ old('phone', $umkm->phone) }}" placeholder="Masukkan nomor telepon">
                                @error('phone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" required
                                class="mt-1 block w-full rounded-lg border-emerald-200 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                                placeholder="Masukkan deskripsi UMKM">{{ old('description', $umkm->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3"
                                class="mt-1 block w-full rounded-lg border-emerald-200 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                                placeholder="Masukkan alamat UMKM">{{ old('address', $umkm->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <div id="dropZone"
                                    ...
                                    <!-- Upload content -->
                                    <div id="dropZoneContent" class="{{ $umkm->thumbnail ? 'hidden' : '' }}">
                                    ...
                                    <!-- Image preview -->
                                    <div id="imagePreview" class="{{ $umkm->thumbnail ? '' : 'hidden' }} mt-4">
                                        <div class="relative max-w-sm mx-auto">
                                            <img src="{{ $umkm->thumbnail ? asset('storage/images/umkms/' . $umkm->thumbnail) : '#' }}"
                                                alt="Preview" class="max-h-64 w-auto mx-auto rounded-lg shadow-sm">
